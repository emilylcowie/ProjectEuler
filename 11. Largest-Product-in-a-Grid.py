    ...
    for i in range(0, 20):
        for j in range(0, 20):
            try:
                ...
                continue
    print(f'The greatest vertical product is {greatest_product}')
    return greatest_product
        ...
        for j in range(0, 20):
            try:
                if j-3 >= 0:
                    ...
                    group_product = grid[i][j] * grid[i +
                                                      1][j-1] * grid[i+2][j-2] * grid[i+3][j-3]
                    if group_product > greatest_product:
                        greatest_product = group_product
            except IndexError:
                continue
    print(f'The greatest diagonal+ve product is {greatest_product}')
    return greatest_product
...
for i in (horizontal(), vertical(), diagonal_positive(), diagonal_negative()):
    if i > answer:
        answer = i
print(answer)
